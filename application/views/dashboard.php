    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mt-element-ribbon bg-grey-steel">
                ...
                <div id="dashboard-test-stats" class="ribbon-content" style="padding-top: 50px;">
                                ...
                                <?php foreach($on_going_tests as $on_going_test) { ?>
                                    ...
                                    <tr class="<?php if($progress == 100) { ?>dashboard-noti-success<?php } ?>">
                                        ...
                                        <td nowrap>
                                            ...
                                            <br />
                                            <a class="button small gray" href="<?php echo base_url()."dashboard/change_date/".$on_going_test['code'];?>" data-target="#change-date-modal" data-toggle="modal">
                                                Change Date
                                            </a>
                                        </td>
