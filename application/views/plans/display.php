                ...
                <div class="portlet-body form">
                    <form role="form" class="validate-form" method="post" action="<?php echo base_url().'plans/display';?>">
                        <div class="form-body" style="padding:0px;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" id="plan-month-part-search-error">
                                        ...
                                        <select name="part_id" class="form-control select2me" id="part-selector"
                                            ...
                                            <?php foreach($parts as $part) { ?>
                                                <option value="<?php echo $part['id']; ?>" <?php if($part['id'] == $selected) { ?> selected="selected" <?php } ?>>
                                                    <?php echo $part['name']; ?>
                                                </option>
                                            <?php } ?>        
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" id="plan-month-supplier-search-error">
                                        <label class="control-label">Select Supplier:</label>
                                                
                                        <select name="supplier_id" class="form-control select2me"
                                            data-placeholder="Select Supplier" data-error-container="#plan-month-supplier-search-error">
                                            <option></option>
                                            <?php $selected = isset($filters['supplier_id']) ? $filters['supplier_id'] : ''; ?>
                                            <?php foreach($suppliers as $supplier) { ?>
                                                <option value="<?php echo $supplier['id']; ?>" <?php if($supplier['id'] == $selected) { ?> selected="selected" <?php } ?>>
