<div class="page-content">
    ...
    <div class="breadcrumbs">
        <h1>
            Upload Part-Test-Chamber Master
        </h1>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo base_url(); ?>">Home</a>
            </li>
            <li class="active">Upload Part-Test-Chamber Master</li>
        </ol>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="portlet light bordered inspection-add-form-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i> Upload Part-Test-Chamber Master Form
                    </div>
                    
                    <div class="actions">
                        <a class="button normals btn-circle" target="_blank" href="<?php echo base_url()."assets/ptc_master_sample.xlsx"; ?>">
